...
namespace CAD_PROYECTO2.ViewModels
{
    ...
    public partial class AllReservasModel : ObservableObject
    {
        ...
        public AllReservasModel(InterfazBDD reservaService)
        {
        ...
        public async void GetReservaList()
        {
            ...
            if (reservaList?.Count > 0)
            {
                ...
                {
                    if(reserva.servicio.Equals("Servicio 1"))
        ...
        {
            await AppShell.Current.GoToAsync(nameof(ReservaServ1));
        }
        ...
        public async void MostrarAccion(Reserva reservaModel)
        {
            ...
            if (response == "Editar")
            {
                ...
                await AppShell.Current.GoToAsync(nameof(ReservaServ1), navParam);
            }
