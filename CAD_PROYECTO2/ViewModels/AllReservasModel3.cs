...
namespace CAD_PROYECTO2.ViewModels
{
    ...
    public partial class AllReservasModel3 : ObservableObject
    {
        ...
        public AllReservasModel3(InterfazBDD reservaService)
        {
        ...
        public async void GetReservaList()
        {
            ...
            if (reservaList?.Count > 0)
            {
                ...
                {
                    if(reserva.servicio.Equals("Servicio 3"))
        ...
        {
            await AppShell.Current.GoToAsync(nameof(ReservaServ3));
        }
        ...
        public async void MostrarAccion(Reserva reservaModel)
        {
            ...
            if (response == "Editar")
            {
                ...
                await AppShell.Current.GoToAsync(nameof(ReservaServ3), navParam);
            }
